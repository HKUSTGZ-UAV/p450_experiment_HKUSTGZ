...
int main(int argc, char **argv)
{
    ...
    // 获取视觉反馈
    ros::Subscriber vision_sub = nh.subscribe<spirecv_msgs::TargetsInFrame>("/uav" + std::to_string(g_uav_id) + "/spirecv/ellipse_detection", 10, VisionCb);
