...
--tab -e 'bash -c "sleep 10; roslaunch p450_experiment ego_planner_depth.launch; exec bash"' \
--tab -e 'bash -c "sleep 12; source ~/.bashrc; roslaunch p450_experiment rviz.launch; exec bash"' \
