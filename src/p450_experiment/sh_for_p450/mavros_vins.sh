...
--tab -e 'bash -c "sleep 5; roslaunch p450_experiment uav_control_main_indoor_vins.launch; exec bash"' \
...
--tab -e 'bash -c "sleep 24; roslaunch p450_experiment rs_camera_720p.launch; exec bash"' \
